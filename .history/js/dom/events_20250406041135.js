...
const toggleResponseMode = () => {
    ...
    // Update UI or agent config based on the new mode
    console.log(`Response mode set to: ${responseMode}`);
    // TODO: Implement UI feedback (e.g., update button icon/text)
    // TODO: Signal the agent to change response behavior if needed
};
